...
def postprocess(frame, outs):
    ...
    classIds = []  # have to fins which class have highest confidence........=====>>><<<<=======
    confidences = []
    boxes = []
    for out in outs:
    ...
    print("Count: " + str(frame_count_out))
    print(count_person)

    if count_person >= 0:
        path = "test_out\\"
        frame_name = os.path.basename(fn)  # trim the path and give file name.
